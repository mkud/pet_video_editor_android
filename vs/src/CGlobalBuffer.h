...
public:
	CGlobalBuffer(unsigned int iSizeBuffer, unsigned int iSizeBuffer2, int width, int height, AVPixelFormat dst_pix_fmt,
			int width_big, int height_big, cv::Rect rectROI, cv::Rect rectFinishROI);
